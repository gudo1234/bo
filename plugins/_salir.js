...
let handler = async (m, { conn, text, command }) => {
 ...
 let txt = `${e} \`Saliendo automáticamente del grupo...\`\n*Nombre:* ${groupMetadata.subject}\n*ID:* ${id}\n> ${fechaHoraMX}`
  await conn.sendButton(m.chat, txt, textbot, icono, [], null, [['ᴏᴡɴᴇʀ/true', `https://wa.me/50492280729?text=Hola+quiero+un+bot+para+mi+grupo,+cuáles+son+los+planes?+`], ['sᴇɢᴜɪʀ ᴄᴀɴᴀʟ', canal]], m)
